...
const CricketCarnival = () => {
  ...
  const [teamLogoColor, setTeamLogoColor] = useState("");
  ...
  // Auto-open modal if ?register=true is in URL query parameters
  useEffect(() => {
  ...
  const validateForm = () => {
    ...
    if (!teamLogoColor.trim()) nextErrors.teamLogoColor = "Jersey/Logo Color description is required";
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    e.preventDefault();
    if (!validateForm()) {
      // Scroll to top of form or show error alert
  ...
  return (
    <main className="overflow-x-hidden bg-[#F8F5EE] paper-texture min-h-screen flex flex-col justify-between select-none relative">
      ...
      <div>
        ...
        <section className="relative bg-primary text-primary-foreground py-20 pb-28 overflow-hidden torn-edge-bottom">
          ...
          <div className="container mx-auto px-6 lg:px-16 relative z-10">
            ...
            <div className="mt-2 text-center max-w-3xl mx-auto space-y-4">
              ...
              <h1 className="text-4xl md:text-6xl font-bold text-primary-foreground tracking-tight font-serif pt-2">
                Navyug Cricket Carnival 2026
              </h1>
              <p className="font-handwriting text-2xl md:text-3xl text-gold rotate-[-1deg] inline-block mt-2">
        ...
        {/* Overview & Scrapbook Details Grid */}
        <section className="py-16 md:py-24 container mx-auto px-6 lg:px-16 relative z-20">
      ...
      {/* REGISTRATION WIZARD DIARY MODAL */}
        ...
        <AnimatePresence>
          {registerModalOpen && (
            <motion.div
              ...
              animate={{ opacity: 1 }}
              exit={{ opacity: 0 }}
              className="fixed inset-0 bg-black/50 backdrop-blur-sm flex items-center justify-center p-4 md:p-6 z-[9999] overflow-y-auto"
              onClick={() => {
                if (success || window.confirm("Are you sure you want to close? Filled data will be lost.")) {
            ...
            >
              <motion.div
                ...
                className="relative bg-[#F8F5EE] paper-texture max-w-3xl w-full border border-primary/20 rounded-md shadow-2xl p-6 md:p-8 text-left overflow-hidden my-8"
                onClick={(e) => e.stopPropagation()}
              >
                {/* Lined notebook styling in modal */}
                ...
                <button
                  ...
                  className="absolute top-4 right-4 w-10 h-10 flex items-center justify-center rounded-full border border-primary/10 hover:border-gold hover:text-gold transition-all z-20 bg-background/80"
                  aria-label="Close modal"
                >
                  <X className="w-5 h-5" />
                </button>

                <div className="relative z-10 pt-4 max-h-[85vh] overflow-y-auto px-4 md:px-6">
                  ...
                  {!success && (
                    <div className="flex items-center justify-center gap-2 mb-6 font-sans">
                      ...
                      <span className="w-8 h-0.5 bg-neutral-300" />
                      <div className={`w-8 h-8 rounded-full border flex items-center justify-center text-xs font-bold ${
                  ...
                  {currentStep === 1 && !success && (
                    <div className="space-y-6">
                      ...
                      <div className="bg-white border border-neutral-200 p-5 rounded-sm space-y-4 max-h-72 overflow-y-auto font-sans text-xs text-neutral-600 leading-relaxed scrollbar-thin">
                        <h4 className="font-bold text-primary text-[13px] uppercase tracking-wider">Tournament Rules & Guidelines</h4>
                      ...
                      <div className="pt-2">
                        <label className="flex items-center gap-3 cursor-pointer text-primary font-sans text-sm">
                          <input
                            type="checkbox"
                            checked={agreedToRules}
                            onChange={(e) => setAgreedToRules(e.target.checked)}
                            className="rounded-sm border-neutral-300 text-primary focus:ring-primary w-4.5 h-4.5"
                          />
                      ...
                      <div className="pt-4 border-t border-neutral-200 flex justify-end">
                        <button
                          ...
                          className="px-8 py-3.5 bg-primary text-background border border-primary text-xs font-bold uppercase tracking-wider hover:bg-transparent hover:text-primary transition-all disabled:opacity-40 active:scale-95 shadow-sm"
                        >
                          Next: Roster Form
                        </button>
                      </div>
                  ...
                  {currentStep === 2 && !success && (
                    <form onSubmit={handleSubmit} className="space-y-6 text-primary">
                      ...
                      <div className="space-y-4">
                        <h4 className="text-xs font-bold text-neutral-500 uppercase tracking-widest font-sans border-b border-neutral-200 pb-1">
                          📋 Section 1: Team Details
                        </h4>
                        <div className="grid md:grid-cols-2 gap-4">
                          <div className="space-y-1">
                            <label className="text-[10px] font-bold text-neutral-500 uppercase font-sans">Team Name *</label>
                            <input
                              type="text"
                              value={teamName}
                              onChange={(e) => {
                              ...
                              className="flex h-9 w-full rounded-sm border border-neutral-300 bg-background px-3 py-1 text-xs font-sans focus:outline-none focus:ring-1 focus:ring-primary text-primary"
                              placeholder="e.g. Nandura Stars"
                            />
                            {errors.teamName && (
                              <p className="text-[10px] text-red-500 font-sans font-semibold">{errors.teamName}</p>
                            )}
                          </div>

                          <div className="space-y-1">
                            <label className="text-[10px] font-bold text-neutral-500 uppercase font-sans">Jersey Color / Team Logo *</label>
                            <input
                              type="text"
                              value={teamLogoColor}
                              onChange={(e) => {
                                setTeamLogoColor(e.target.value);
                                if (errors.teamLogoColor) setErrors(prev => ({ ...prev, teamLogoColor: "" }));
                              }}
                              className="flex h-9 w-full rounded-sm border border-neutral-300 bg-background px-3 py-1 text-xs font-sans focus:outline-none focus:ring-1 focus:ring-primary text-primary"
                              placeholder="e.g. Yellow & Blue Stripes"
                            />
                            {errors.teamLogoColor && (
                              <p className="text-[10px] text-red-500 font-sans font-semibold">{errors.teamLogoColor}</p>
                            )}
                          </div>
                        </div>
                      </div>
                      ...
                      <div className="space-y-4 pt-2">
                        ...
                        <div className="grid md:grid-cols-2 gap-4">
                          <div className="space-y-1">
                            <label className="text-[10px] font-bold text-neutral-500 uppercase font-sans">Captain's Full Name *</label>
                            <input
                              type="text"
                              value={captainName}
                              onChange={(e) => {
                            ...
                            />
                            {errors.captainName && (
                              <p className="text-[10px] text-red-500 font-sans font-semibold">{errors.captainName}</p>
                            )}
                          </div>
                          ...
                          <div className="space-y-1">
                            ...
                            />
                            {errors.captainAge && (
                              <p className="text-[10px] text-red-500 font-sans font-semibold">{errors.captainAge}</p>
                            )}
                          </div>

                          <div className="space-y-1">
                            <label className="text-[10px] font-bold text-neutral-500 uppercase font-sans">WhatsApp Number (Optional)</label>
                            <input
                              type="tel"
                          ...
                          <div className="space-y-1">
                            <label className="text-[10px] font-bold text-neutral-500 uppercase font-sans">Email Address *</label>
                            <input
                              type="email"
                              value={captainEmail}
                              onChange={(e) => {
                            ...
                            />
                            {errors.captainEmail && (
                              <p className="text-[10px] text-red-500 font-sans font-semibold">{errors.captainEmail}</p>
                            )}
                          </div>

                          <div className="space-y-1 md:col-span-2">
                            <label className="text-[10px] font-bold text-neutral-500 uppercase font-sans">City / Hometown *</label>
                            <input
                              type="text"
                              value={captainCity}
                              onChange={(e) => {
                            ...
                            />
                            {errors.captainCity && (
                              <p className="text-[10px] text-red-500 font-sans font-semibold">{errors.captainCity}</p>
                            )}
                          </div>
                        </div>
                      </div>
                      ...
                      <div className="space-y-4 pt-2">
                        <div className="border-b border-neutral-200 pb-1">
                          <h4 className="text-xs font-bold text-neutral-500 uppercase tracking-widest font-sans">
                            🏏 Section 3: Player Roster (7 Playing + 1 Substitute)
                          </h4>
                          <p className="text-[9px] text-neutral-400 font-sans mt-0.5 leading-relaxed">
                            Player #8 is marked as the Substitute player. All details are required for identification checks.
                          </p>
                        </div>

                        <div className="space-y-4 max-h-96 overflow-y-auto pr-1 scrollbar-thin">
                          {players.map((player, idx) => (
                            <div key={idx} className="bg-[#FFFDF6] p-4 border border-neutral-200 rounded-sm space-y-3 relative shadow-inner">
                              <div className="flex justify-between items-center border-b border-neutral-100 pb-1">
                                <span className="text-[10px] font-bold text-primary font-sans uppercase tracking-wider">
                                  Player #{player.number} {idx === 7 && <span className="text-gold font-bold font-handwriting lowercase text-xs ml-1">(Substitute)</span>}
                                </span>
                              </div>

                              <div className="grid grid-cols-1 md:grid-cols-2 gap-3 text-primary">
                                <div className="space-y-1">
                                  <label className="text-[9px] font-bold text-neutral-500 uppercase font-sans">Full Name *</label>
                                  <input
                                    type="text"
                                  ...
                                  {errors[`players_${idx}_fullName`] && (
                                    <p className="text-[9px] text-red-500 font-sans font-semibold">{errors[`players_${idx}_fullName`]}</p>
                                  )}
                                </div>

                                <div className="space-y-1">
                                  <label className="text-[9px] font-bold text-neutral-500 uppercase font-sans">Age *</label>
                                  <input
                                    type="number"
                                    value={player.age}
                                  ...
                                  {errors[`players_${idx}_age`] && (
                                    <p className="text-[9px] text-red-500 font-sans font-semibold">{errors[`players_${idx}_age`]}</p>
                                  )}
                                </div>

                                <div className="space-y-1">
                                  <label className="text-[9px] font-bold text-neutral-500 uppercase font-sans">Mobile Number *</label>
                                  <input
                                    type="tel"
                                  ...
                                  {errors[`players_${idx}_mobileNumber`] && (
                                    <p className="text-[9px] text-red-500 font-sans font-semibold">{errors[`players_${idx}_mobileNumber`]}</p>
                                  )}
                                </div>

                                <div className="space-y-1">
                                  <label className="text-[9px] font-bold text-neutral-500 uppercase font-sans">Playing Role *</label>
                                  <select
                                ...
                                <div className="space-y-1 md:col-span-2">
                                  <label className="text-[9px] font-bold text-neutral-500 uppercase font-sans">Email Address *</label>
                                  <input
                                    type="email"
                                    value={player.mail}
                                  ...
                                  {errors[`players_${idx}_mail`] && (
                                    <p className="text-[9px] text-red-500 font-sans font-semibold">{errors[`players_${idx}_mail`]}</p>
                                  )}
                                </div>
                              </div>
                            </div>
                      ...
                      <div className="space-y-3 pt-2">
                        ...
                        <div className="space-y-2 font-sans text-xs">
                          <label className="text-[10px] font-bold text-neutral-500 uppercase block">Combined Aadhaar Card Document *</label>
                          <div className="flex items-center gap-3">
                            <label className="inline-flex items-center justify-center px-4 py-2.5 border border-neutral-300 bg-background text-neutral-700 font-bold text-xs uppercase tracking-wider rounded-sm cursor-pointer hover:bg-neutral-50 active:scale-95 transition-all shadow-sm">
                          ...
                          {errors.aadhaarFile && (
                            <p className="text-[10px] text-red-500 font-sans font-semibold">{errors.aadhaarFile}</p>
                          )}
                        </div>
                      </div>
                      ...
                      <div className="space-y-4 pt-2">
                        ...
                        <div className="space-y-3 text-xs">
                          <div className="space-y-1">
                            <label className="text-[10px] font-bold text-neutral-500 uppercase font-sans">Captain's Signature (Type Full Name to Sign) *</label>
                            <input
                              type="text"
                              ...
                              className="flex h-9 w-full rounded-sm border border-neutral-300 bg-background px-3 py-1 text-xs font-sans focus:outline-none focus:ring-1 focus:ring-primary text-primary font-handwriting text-lg"
                              placeholder="e.g. John Doe"
                            />
                            {errors.captainSignature && (
                              <p className="text-[10px] text-red-500 font-sans font-semibold">{errors.captainSignature}</p>
                            )}
                          </div>

                          <div className="pt-2">
                            <label className="flex items-start gap-2.5 cursor-pointer text-primary font-sans">
                              <input
                                type="checkbox"
                                checked={agreement}
                                onChange={(e) => {
                                ...
                                className="rounded-sm border-neutral-300 text-primary focus:ring-primary w-4.5 h-4.5 mt-0.5"
                              />
                            ...
                            {errors.agreement && (
                              <p className="text-[10px] text-red-500 font-sans font-semibold mt-1">{errors.agreement}</p>
                            )}
                          </div>
                        </div>
                      </div>
                      ...
                      {/* Form Actions */}
                      <div className="pt-4 border-t border-neutral-200 flex justify-between items-center font-sans text-xs">
                        <button
                          type="button"
                        ...
                        <button
                          type="submit"
                          disabled={loading}
                          className="px-8 py-3 bg-primary text-background border border-primary font-bold uppercase tracking-wider hover:bg-transparent hover:text-primary transition-all disabled:opacity-50 flex items-center gap-2 active:scale-95"
                        >
                          {loading ? (
                            <>
                  ...
                  {success && (
                    ...
                    >
                      ...
                      <div className="max-w-md bg-white border border-neutral-200 p-5 rounded-sm shadow-sm text-xs text-neutral-600 leading-relaxed text-left space-y-4">
                        <p className="font-bold text-primary text-sm">Thank you, Captain {captainName}!</p>
                        <p>
                        ...
                        <div className="bg-amber-50 border border-amber-200 p-3.5 rounded-sm text-[11px] text-amber-800 space-y-1">
                      ...
                      <button
                        ...
                        type="button"
                        className="px-8 py-3 bg-primary text-background border border-primary text-xs font-bold uppercase tracking-wider hover:bg-transparent hover:text-primary transition-all shadow-sm active:scale-95"
                      >
                        Back to Stadium
                      </button>
                    </motion.div>
